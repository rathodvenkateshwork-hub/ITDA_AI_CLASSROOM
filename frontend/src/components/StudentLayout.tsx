...
import { Menu, Settings, LogOut, Home, BookOpen, Award, Zap, BarChart3, MessageCircle } from 'lucide-react';
          ...
          <div className="px-8 py-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <div className="text-right">
                <p className="text-sm font-semibold text-gray-900">John Student</p>
